...
If data are imported successfully, in _Data Import log_ output, overview of the data structure will be presented along with information about identified numeric/categorical 
variables. <br/><br/>
